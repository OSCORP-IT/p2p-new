...
export class Edit extends Component {
    ...
    handleSubmit = (event) => {
        ...
        AxiosAPI.post(/api/user-panel/dashboard/my-account-update, {
                name: user.name,
                gender: user.gender,
                                            ...
                                            <div className="card-body">
                                                <form onSubmit={this.handleSubmit}>
                                                    ...
                                                    <div className="row g-2">
                                                        ...
                                                        <div className="mb-2 col-md-4">
                                                            <label htmlFor="username"> Mail <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" id="username" name="username" value={user.username} onChange={this.handleInputChange} placeholder="e.g: example@f-mail.com" required />
                                                        </div>
