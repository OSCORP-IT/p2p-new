import HeroImg from "../../assets/FuneralServicesHero.png";
import PrimaryButton from "../../components/PrimaryButton";
import Title from "../../components/Title";
import Text from "../../components/Text";
import { useNavigate } from "react-router-dom";
function PLFuneralHero() {
      ...
      <div className="pt-4 px-4 tab:px-0 tab:w-11/12 laptop:w-5/6 m-auto flex flex-wrap sm:flex-nowrap items-center justify-between tab:h-[410px]">
        <div className="hidden sm:block sm:w-2/3 tab:w-3/5">
          ...
          <Title padding={"py-0 leading-tight"} color={`text-titleColor`}>
            Financing for memorial services
          </Title>
          <Text padding={`py-2`}>
            The loss of a loved one is challenging. Through Prosper, we aim to
            alleviate the financial burdens of arranging a memorial service.
          </Text>
