...
function ThreeSteps() {
  return (
    <SectionLayout>
      ...
      <div className="flex flex-wrap sm:flex-nowrap items-start justify-between gap-8 py-8">
        <div className="w-full sm:w-1/3 sm:h-[350px] tab:h-[250px] rounded-md shadow-allSide shadow-gray-200 p-4 smLap:p-6 flex gap-4 items-start">
          ...
          <div>
            ...
            <Text>
              ...
              touch with you to discuss further on your financing requirements.
            </Text>
          </div>
        </div>
        <div className="w-full sm:w-1/3 sm:h-[350px] tab:h-[250px] rounded-md shadow-allSide shadow-gray-200 p-4 smLap:p-6 flex gap-4 items-start">
