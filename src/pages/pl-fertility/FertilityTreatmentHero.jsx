import HeroImg from "../../assets/FertilityTreatment.png";
import PrimaryButton from "../../components/PrimaryButton";
import Title from "../../components/Title";
import Text from "../../components/Text";
function FertilityTreatmentHero() {
  return (
    <div className="w-full relative overflow-hidden">
      ...
      <div className="pt-4 px-4 tab:px-0 tab:w-10/12 m-auto flex flex-wrap sm:flex-nowrap items-center justify-between tab:h-[400px]">
        <div className="hidden sm:block sm:w-2/3 tab:w-3/5">
          ...
          <Text padding={`py-2`}>
            The journey to conceive can be stressful. Prosper takes the worry
            out of financing fertility medications and procedures.
          </Text>
        ...
        <div className="sm:hidden w-full pt-4">
          ...
          >
            Loans for IVF & fertility treatment
          </Title>
...
export default FertilityTreatmentHero;
