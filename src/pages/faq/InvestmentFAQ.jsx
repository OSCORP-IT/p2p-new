...
function InvestmentFAQ({ setCurrentPage }) {
  ...
  useEffect(() => {
    async function fetchGeneralFAQ() {
      ...
      try {
        const result = await getFaq("investment_general_enquiries");
  ...
  useEffect(() => {
    async function fetchFintechFAQ() {
      ...
      try {
        const result = await getFaq("investment_fintech_platinum");
  ...
  return (
    <div className="relative w-full">
      ...
      <Heading1 align={`text-center`}>FAQ for Investment</Heading1>
      <div className="py-4">
