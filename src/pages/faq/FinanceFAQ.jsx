...
function FinanceFAQ({ setCurrentPage }) {
  ...
  useEffect(() => {
    async function fetchGeneralFAQ() {
      ...
      try {
        const result = await getFaq("financing_general_enquiries");
  ...
  useEffect(() => {
    async function fetchFintechFAQ() {
      ...
      try {
        const result = await getFaq("financing_fintech_platinum");
  ...
  return (
    <div className="relative w-full">
      ...
      <Heading1 align={`text-center`}>FAQ for Financing</Heading1>
      <div className="py-4">
