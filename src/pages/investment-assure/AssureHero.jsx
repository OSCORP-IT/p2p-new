...
function AssureHero() {
  return (
    <div className="w-full relative">
      ...
      <div className="absolute -bottom-10 right-0 -z-50 blur-[150px] bg-accent/50 rounded-full w-[150px] tab:w-[300px] h-[150px] tab:h-[300px]"></div>
